...
function SanityPDP(props: IProduct) {
    return (
        <div>
                    ...
                    <div className="flex flex-col md:flex-row ">
                        ...
                        <div className="flex-1 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex price items-center mb-10 gap-4">
                                ...
                                {/* {cartItem.price && ( */}
                                    <span
                                        className={`block text-5xl text-gray ${props.discounted
                                    ...
                                    <div className="save flex flex-col justify-center">
                                        ...
                                        <div className="flex">
                                            <span className="text-blue-500 font-semibold">
                                                ${(props.price - props.discounted).toFixed(2)}
                                            </span>
                                            <span className="text-red-500 ml-2 font-semibold">
                                                (
                                                {((props.discounted / props.price) * 100).toFixed(
                                                    0
                                                )}
                                                %)
                                            </span>
                                    ...
                                    {/* {cartItem.qty > 1 && ( */}
                                        <div className="pricebox flex items-center gap-4">
                                            <div>
                                                ...
                                                {/* {cartItem.price && ( */}
                                                    <span
                                                        className={`block text-md text-gray ${props.discounted
                                                                ? props.discounted < props.price &&
                                                                "line-through"
                                                                : "font-semibold"
                                                            }`}
                                                    >
                            ...
                            <div className="card-actions w-full justify-between">
                                <button className="w-full h-full text-lg uppercase">
                                    Add to cart
                                </button>
